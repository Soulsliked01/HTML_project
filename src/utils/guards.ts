...
// ← AVANT isNewUserDTO et isUserDTO
function isValidEmail(obj: any): obj is string {
  return isNonEmptyString(obj) && /^[^@]+@[^@]+\.[^@]+$/.test(obj);
}

// == USER ==
export function isNewUserDTO(obj: any): obj is NewUserDTO {
  return obj && typeof obj === 'object' &&
    obj.email && isValidEmail(obj.email) &&        // ← isValidEmail
